...
echo "  • Re-runs: <1 minute (all cached)"
echo ""
echo "Next steps:"
echo "  1. Select a model:       ./run/select_model.sh"
echo "  2. Start vLLM server:    ./run/vllm.sh"
echo "  3. Start proxy:          ./run/proxy.sh"
echo ""
echo "Optional - For vision support:"
echo "  4. Build llama.cpp:      ./setup/build_llamacpp.sh"
echo "  5. Download vision model: ./stack/download_vision_model.sh qwen2-vl-2b-q4"
echo "  6. Start vision server:  ./run/vision.sh"
echo "========================================="
